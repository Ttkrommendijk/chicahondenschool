...
import { page as hondenschoolPage } from "../data/diensten/hondenschool";
import { page as oppasPage } from "../data/diensten/oppas-uitlaatservice";
import { dienstenIndexPage, serviceList } from "../data/diensten";
import { dienst as dienst5Privelessen } from "../data/diensten/5-privelessen-op-maat";
import { dienst as dienstPrivelesAanHuis } from "../data/diensten/priveles-aan-huis";
import { dienst as dienstPrivelesOpLocatie } from "../data/diensten/priveles-op-locatie";
import { dienst as dienstFunSpeuren } from "../data/diensten/fun-speuren-neuswerk";
import { dienst as dienstDetectie } from "../data/diensten/detectie";
import { dienst as dienstSportEnSpel } from "../data/diensten/sport-en-spel";
import { dienst as dienstKennismaking } from "../data/diensten/kennismaking";
import { dienst as dienstStrippenkaart } from "../data/diensten/strippenkaart";
