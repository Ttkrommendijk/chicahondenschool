...
export const page = {
  ...
  hero: {
    ...
    subtitle: l10n(
      "Betrouwbare 1-op-1 oppas en uitlaatservice aan huis in Den Haag, Rijswijk, Voorschoten en omstreken, met persoonlijke aandacht voor je hond.",
      "Reliable 1-on-1 in-home pet sitting and walking service in Den Haag, RijswijkVoorschoten and surrounding areas, with personal attention for your dog.",
    ),
